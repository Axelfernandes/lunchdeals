...
// Convert GPS coordinates to city name (Mocked for LA)
...
export async function fetchDeals(userLocation) {
    try {
        console.log('🚀 PoC Mode: Generating LA deals for location:', userLocation);

        // Always generate LA-specific mock data for PoC
        ...
        console.log(`✅ Total LA deals generated: ${dealsWithDistance.length}`);
...
// Generate high-quality mock deals for Los Angeles
function generateLAMockDeals(userLocation) {
    const hotspots = [
    ...
    const laRestaurants = [
        // Santa Monica / Venice (Beach vibes, Healthy)
        ...
        // Hollywood / Silver Lake (Hipster, Cool)
        ...
        // Westwood / Beverly Hills (Upscale)
    ...
    // Duplicate and vary restaurants to reach 50+ deals
    for (let i = 0; i < 50; i++) {
        ...
        // Jitter coordinates within neighborhood
